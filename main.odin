...
main :: proc() {
	...
	if os.args[1] == "all" || os.args[1] == "2414" do time_func(d2414.day, "24/14/input.txt")
	if os.args[1] == "all" || os.args[1] == "2415" do time_func(d2415.day, "24/15/input.txt")
	if os.args[1] == "all" || os.args[1] == "2416" do time_func(d2416.day, "24/16/input.txt")
	if os.args[1] == "all" || os.args[1] == "2417" do time_func(d2417.day, "24/17/input.txt")
	...
	if os.args[1] == "all" || os.args[1] == "2421" do time_func(d2421.day, "24/21/input.txt")
	if os.args[1] == "all" || os.args[1] == "2422" do time_func(d2422.day, "24/22/input.txt")
	if os.args[1] == "all" || os.args[1] == "2423" do time_func(d2423.day, "24/23/input.txt")
	if os.args[1] == "all" || os.args[1] == "2424" do time_func(d2424.day_2, "24/24/input.txt")
